...
Assignment.create(project_id: project_1.id, employee_id: employee_3.id)
Assignment.create(project_id: project_1.id, employee_id: employee_4.id)
Assignment.create(project_id: project_1.id, employee_id: employee_9.id)
Assignment.create(project_id: project_1.id, employee_id: employee_10.id)
Assignment.create(project_id: project_1.id, employee_id: employee_13.id)
Assignment.create(project_id: project_1.id, employee_id: employee_14.id)

Assignment.create(project_id: project_1.id, employee_id: employee_11.id)
Assignment.create(project_id: project_1.id, employee_id: employee_12.id)
Assignment.create(project_id: project_1.id, employee_id: employee_14.id)
Assignment.create(project_id: project_1.id, employee_id: employee_15.id)
